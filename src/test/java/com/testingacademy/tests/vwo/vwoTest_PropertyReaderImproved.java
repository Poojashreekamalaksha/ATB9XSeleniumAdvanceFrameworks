...
public class vwoTest_PropertyReaderImproved extends CommonToAllTest {

    private static final Logger logger = LogManager.getLogger(vwoTest_PropertyReaderImproved.class);
    @Owner("POOJASHREE")
